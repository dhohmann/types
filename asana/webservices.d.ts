...
export interface paths {
  ...
  "/memberships": {
     ...
     * @description Returns compact `goal_membership` or `project_membership` records. The possible types for `parent` in this request are `goal` or `project`. An additional member (user GID or team GID) can be passed in to filter to a specific membership.
     */
    get: operations["getMemberships"];
    /**
     * Create a membership
     * @description Creates a new membership in a `goal` or `project`. `Teams` or `users` can be a member
  ...
  "/memberships/{membership_gid}": {
    /**
     * Get a membership
     * @description Returns compact `project_membership` record for a single membership. `GET` only supports project memberships currently
     */
    get: operations["getMembership"];
    /**
     * Update a membership
     * @description An existing membership can be updated by making a `PUT` request on the URL for
     * that goal. Only the fields provided in the `data` block will be updated;
    ...
    /**
     * Delete a membership
     * @description A specific, existing membership for a `goal` or `project` can be deleted by making a `DELETE` request
...
export interface components {
  schemas: {
    AllocationBase: components["schemas"]["AsanaResource"] & ({
      /**
       * Format: date
    ...
    AsanaNamedResource: components["schemas"]["AsanaResource"] & {
      /**
    ...
    AttachmentCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    AttachmentResponse: components["schemas"]["AttachmentBase"] & ({
      ...
      parent?: components["schemas"]["TaskCompact"] & (({
         ...
         */
        readonly resource_subtype?: string | null;
      }) | null);
      /**
    ...
    CustomFieldCompact: components["schemas"]["AsanaResource"] & ({
      /**
      ...
      enum_value?: components["schemas"]["EnumOption"] & (Record<string, unknown> | null);
    ...
    CustomFieldSettingCompact: components["schemas"]["AsanaResource"] & Record<string, never>;
    ...
    EnumOption: components["schemas"]["AsanaResource"] & {
      /**
    ...
    EventResponse: {
       ...
       */
      action?: string;
      parent?: components["schemas"]["AsanaNamedResource"];
      /**
       * Format: date-time
      ...
      change?: {
         ...
         * }
         */
        readonly removed_value?: unknown;
      };
    };
    ...
    GoalBase: components["schemas"]["AsanaResource"] & ({
      /**
    ...
    GoalCompact: components["schemas"]["AsanaResource"] & ({
      /**
       * @description The name of the goal.
       * @example Grow web traffic by 30%
       */
      name?: string;
      owner?: components["schemas"]["UserCompact"] & (Record<string, unknown> | null);
    });
    GoalMetricBase: components["schemas"]["AsanaResource"] & ({
      /**
    ...
    GoalMetricCurrentValueRequest: components["schemas"]["AsanaResource"] & {
      /**
    ...
    GoalResponse: components["schemas"]["GoalBase"] & ({
      ...
      likes?: readonly components["schemas"]["Like"][];
      /**
       * @description The number of users who have liked this goal.
       * @example 5
       */
      num_likes?: number;
      team?: components["schemas"]["TeamCompact"] & (Record<string, unknown> | null);
      ...
      time_period?: components["schemas"]["TimePeriodCompact"] & (Record<string, unknown> | null);
      ...
      owner?: components["schemas"]["UserCompact"] & (Record<string, unknown> | null);
      current_status_update?: components["schemas"]["StatusUpdateCompact"];
      /**
       * @description The current status of this goal. When the goal is open, its status can be `green`, `yellow`, and `red` to reflect "On Track", "At Risk", and "Off Track", respectively. When the goal is closed, the value can be `missed`, `achieved`, `partial`, or `dropped`.
       * *Note* you can only write to this property if `metric` is set.
       * @example green
    ...
    GoalRelationshipCompact: components["schemas"]["AsanaResource"] & ({
      /**
       * @description The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.
       * @example subgoal
       * @enum {string}
    ...
    JobCompact: components["schemas"]["AsanaResource"] & ({
      /**
       * @description The subtype of this resource. Different subtypes retain many of the same fields and behavior, but may render differently in Asana or represent resources with different semantic meaning.
      ...
      new_task?: components["schemas"]["TaskCompact"] & (Record<string, unknown> | null);
    ...
    MemberCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    MembershipCompact: components["schemas"]["GoalMembershipCompact"] | components["schemas"]["ProjectMembershipCompactResponse"];
    /**
     * @example {
     *   "dependencies": [
     *     "133713",
    ...
    OrganizationExportCompact: components["schemas"]["AsanaResource"] & ({
      /**
       * Format: date-time
       * @description The time at which this resource was created.
       * @example 2012-02-22T02:06:58.147Z
    ...
    PortfolioCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    PortfolioMembershipCompact: components["schemas"]["AsanaResource"] & {
    ...
    PortfolioResponse: components["schemas"]["PortfolioBase"] & ({
      ...
      members?: readonly components["schemas"]["UserCompact"][];
      ...
      project_templates?: readonly components["schemas"]["ProjectTemplateCompact"][];
    });
    /**
    ...
    ProjectBase: components["schemas"]["ProjectCompact"] & ({
       ...
       */
      created_at?: string;
      current_status?: components["schemas"]["ProjectStatusResponse"] & (Record<string, unknown> | null);
      current_status_update?: components["schemas"]["StatusUpdateCompact"] & (Record<string, unknown> | null);
      /** @description Array of Custom Field Settings (in compact form). */
      custom_field_settings?: readonly components["schemas"]["CustomFieldSettingResponse"][];
      /**
    ...
    ProjectBriefCompact: components["schemas"]["AsanaResource"] & Record<string, never>;
    ...
    ProjectCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    ProjectMembershipCompact: components["schemas"]["AsanaResource"] & ({
    ...
    ProjectResponse: components["schemas"]["ProjectBase"] & ({
      /** @description Array of Custom Fields. */
      custom_fields?: readonly components["schemas"]["CustomFieldCompact"][];
      /**
      ...
      completed_by?: components["schemas"]["UserCompact"];
      ...
      followers?: readonly components["schemas"]["UserCompact"][];
      /** @description The current owner of the project, may be null. */
      owner?: components["schemas"]["UserCompact"] & (Record<string, unknown> | null);
       ...
       */
      permalink_url?: string;
      project_brief?: components["schemas"]["ProjectBriefCompact"] & (Record<string, unknown> | null);
      created_from_template?: components["schemas"]["ProjectTemplateCompact"] & (Record<string, unknown> | null);
      workspace?: components["schemas"]["WorkspaceCompact"] & Record<string, never>;
    });
    ...
    ProjectStatusCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    ProjectTemplateCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    ProjectTemplateBase: components["schemas"]["ProjectTemplateCompact"] & ({
      ...
      requested_dates?: readonly components["schemas"]["DateVariableCompact"][];
      /**
    ...
    SectionCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    SectionResponse: components["schemas"]["SectionBase"] & {
      ...
      projects?: readonly components["schemas"]["ProjectCompact"][];
    };
    ...
    StatusUpdateCompact: components["schemas"]["AsanaResource"] & ({
      /**
    ...
    StatusUpdateResponse: components["schemas"]["StatusUpdateBase"] & ({
      ...
      hearts?: readonly components["schemas"]["Like"][];
      /**
    ...
    StoryBase: components["schemas"]["AsanaResource"] & ({
      /**
       * Format: date-time
       * @description The time at which this resource was created.
       * @example 2012-02-22T02:06:58.147Z
    ...
    StoryCompact: components["schemas"]["AsanaResource"] & {
      /**
       * Format: date-time
       * @description The time at which this resource was created.
       * @example 2012-02-22T02:06:58.147Z
    ...
    StoryResponse: components["schemas"]["StoryBase"] & ({
       ...
       */
      previews?: readonly components["schemas"]["Preview"][];
      /**
      ...
      /** @description *Conditional* */
      story?: components["schemas"]["StoryCompact"];
      /** @description *Conditional* */
      assignee?: components["schemas"]["UserCompact"];
      /** @description *Conditional* */
      follower?: components["schemas"]["UserCompact"];
      /** @description *Conditional* */
      old_section?: components["schemas"]["SectionCompact"];
      /** @description *Conditional* */
      new_section?: components["schemas"]["SectionCompact"];
      /** @description *Conditional* */
      task?: components["schemas"]["TaskCompact"];
      /** @description *Conditional* */
      project?: components["schemas"]["ProjectCompact"];
      /** @description *Conditional* */
      tag?: components["schemas"]["TagCompact"];
      /** @description *Conditional* */
      custom_field?: components["schemas"]["CustomFieldCompact"];
      /**
       * @description *Conditional*
      ...
      /** @description *Conditional* */
      old_enum_value?: components["schemas"]["EnumOption"];
      /** @description *Conditional* */
      new_enum_value?: components["schemas"]["EnumOption"];
      old_date_value?: components["schemas"]["StoryResponseDates"];
      new_date_value?: components["schemas"]["StoryResponseDates"];
      /** @description *Conditional*. The old value of a people custom field story. */
      old_people_value?: readonly components["schemas"]["UserCompact"][];
      /** @description *Conditional*. The new value of a people custom field story. */
      new_people_value?: readonly components["schemas"]["UserCompact"][];
      /** @description *Conditional*. The old value of a multi-enum custom field story. */
      old_multi_enum_values?: readonly components["schemas"]["EnumOption"][];
      /** @description *Conditional*. The new value of a multi-enum custom field story. */
      new_multi_enum_values?: readonly components["schemas"]["EnumOption"][];
      /**
      ...
      /** @description *Conditional* */
      duplicate_of?: components["schemas"]["TaskCompact"];
      /** @description *Conditional* */
      duplicated_from?: components["schemas"]["TaskCompact"];
      /** @description *Conditional* */
      dependency?: components["schemas"]["TaskCompact"];
      /**
    ...
    /** @description *Conditional* */
    readonly StoryResponseDates: {
      /**
       * Format: date
       * @description The day on which work for this goal begins, or null if the goal has no start date. This takes a date with `YYYY-MM-DD` format, and cannot be set unless there is an accompanying due date.
       * @example 2019-09-14
       */
      readonly start_on?: string | null;
      /**
       * Format: date-time
    ...
    TagCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    TagRequest: components["schemas"]["TagBase"] & {
      /**
       * @description An array of strings identifying users. These can either be the string "me", an email, or the gid of a user.
       * @example [
       *   "12345",
    ...
    TaskBase: components["schemas"]["TaskCompact"] & ({
      ...
      dependencies?: readonly components["schemas"]["AsanaResource"][];
      ...
      dependents?: readonly components["schemas"]["AsanaResource"][];
      /**
       * Format: date-time
       * @description The UTC date and time on which this task is due, or null if the task has no due time. This takes an ISO 8601 date string in UTC and should not be used together with `due_on`.
    ...
    TaskCompact: components["schemas"]["AsanaResource"] & ({
      /**
    ...
    TaskTemplateCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    TaskResponse: components["schemas"]["TaskBase"] & ({
      assignee?: components["schemas"]["UserCompact"];
      assignee_section?: components["schemas"]["SectionCompact"] & (Record<string, unknown> | null);
      ...
      custom_fields?: readonly components["schemas"]["CustomFieldResponse"][];
      /** @description Array of users following this task. */
      followers?: readonly components["schemas"]["UserCompact"][];
      parent?: components["schemas"]["TaskCompact"] & (Record<string, unknown> | null);
       ...
       * ]
       */
      tags?: readonly components["schemas"]["TagCompact"][];
      workspace?: components["schemas"]["WorkspaceCompact"] & Record<string, never>;
      /**
       * @description A url that points directly to the object within Asana.
       * @example https://app.asana.com/0/resource/123456789/list
    ...
    TeamCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    TeamMembershipCompact: components["schemas"]["AsanaResource"] & {
      user?: components["schemas"]["UserCompact"];
      team?: components["schemas"]["TeamCompact"];
      /**
    ...
    TemplateRole: components["schemas"]["AsanaResource"] & {
      /**
    ...
    TimePeriodBase: components["schemas"]["TimePeriodCompact"] & {
      parent?: components["schemas"]["TimePeriodCompact"];
    };
    TimePeriodCompact: components["schemas"]["AsanaResource"] & ({
      /**
    ...
    UserCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    UserBaseResponse: components["schemas"]["UserBase"] & ({
      ...
      photo?: {
        /** Format: uri */
        readonly image_21x21?: string;
        /** Format: uri */
        readonly image_27x27?: string;
        /** Format: uri */
        readonly image_36x36?: string;
        /** Format: uri */
        readonly image_60x60?: string;
        /** Format: uri */
        readonly image_128x128?: string;
        /** Format: uri */
    ...
    UserResponse: components["schemas"]["UserBaseResponse"] & {
       ...
       */
      workspaces?: readonly components["schemas"]["WorkspaceCompact"][];
    };
    UserTaskListBase: components["schemas"]["UserTaskListCompact"];
    UserTaskListCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    WebhookCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    WebhookRequest: {
      ...
      filters?: (components["schemas"]["WebhookFilter"] & Record<string, never>)[];
    };
    ...
    WorkspaceCompact: components["schemas"]["AsanaResource"] & {
      /**
    ...
    WorkspaceMembershipCompact: components["schemas"]["AsanaResource"] & {
      user?: components["schemas"]["UserCompact"];
      workspace?: components["schemas"]["WorkspaceCompact"];
    };
    ...
    WorkspaceMembershipResponse: components["schemas"]["WorkspaceMembershipBase"] & ({
      ...
      user_task_list?: components["schemas"]["UserTaskListResponse"];
    ...
    GoalMembershipBase: components["schemas"]["AsanaResource"] & ({
      /**
       * @description The base type of this resource.
       * @example membership
       */
    ...
    MembershipResponse: components["schemas"]["GoalMembershipResponse"] | components["schemas"]["ProjectMembershipCompactResponse"];
    ...
    TimeTrackingEntryCompact: components["schemas"]["AsanaResource"] & {
      /**
  ...
  getMembership: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ProjectMembershipCompactResponse"];
          };
        };
      };
      400: components["responses"]["BadRequest"];
  ...
  getPortfolioMemberships: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["PortfolioMembershipCompact"][];
            next_page?: components["schemas"]["NextPage"];
          };
        };
      };
  ...
  getPortfolioMembership: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["PortfolioMembershipResponse"];
          };
        };
      };
      400: components["responses"]["BadRequest"];
